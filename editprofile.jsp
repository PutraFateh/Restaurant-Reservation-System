                        ...
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="editprofile.jsp?id=<%=uid %>">Profile</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
										<form method="post" action="login">
											...
											<p class="text-muted font-14 mb-4">Please fill the form to if you want to change the profile.</p>
											<div class="form-group">
												<label for="example-time-input" class="col-form-label">Email</label>
												<input class="form-control" type="text" name="edit_email" value="<%=resultSet.getString("cust_email") %>">
											</div>
											<div class="form-group">
												<label for="example-time-input" class="col-form-label">Name</label>
												<input class="form-control" type="text" name="edit_name" value="<%=resultSet.getString("cust_name") %>">
											</div>
											<div class="form-group">
												<label for="example-time-input" class="col-form-label">Contact Number</label>
												<input class="form-control" type="number" name="edit_contact" value="<%=resultSet.getString("cust_contact") %>">
											</div>
											<input type="text" name="edit_id" value="<%=resultSet.getString("cust_id")%>" hidden>
											<button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="edit_profile_submit">Submit</button>
											<%
											}
											connection.close();
											} catch (Exception e) {
