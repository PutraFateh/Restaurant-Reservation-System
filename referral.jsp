                        ...
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="referral.jsp">Referral QR Code</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
										<form method="post" action="login">
											...
											while(resultSet.next()){
											%>
											<h4 class="header-title">Referral ID</h4>
											<p class="text-muted font-14 mb-4">Please scan or give to your friends to receive points.</p>
											<div class="form-group">
												<label for="example-time-input" class="col-form-label">QR Code: </label>
												<img id='barcode' style="position:center; TOP:70px; WIDTH:85px; HEIGHT:85px"
												src='https://api.qrserver.com/v1/create-qr-code/?data=register.jsp?id=<%=resultSet.getString("cust_id") %>&amp;size=100x100'
												title="HELLO" width="100" height="100"/>
											</div>
											<div class="form-group">
												<label for="example-time-input" class="col-form-label">Link register:</label>
												<a href="register.html?id=<%=resultSet.getString("cust_id") %>" class="text-secondary">register.jsp?id=<%=resultSet.getString("cust_id") %></i></a>
											</div>
											<%
											}
											connection.close();
